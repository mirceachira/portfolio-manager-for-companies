    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    models.EmailField(help_text="company's email", max_length=254),
                ),
                (
                    "phone",
                    models.TextField(
                        blank=True, help_text="company's phone", null=True
                    ),
                ),
                (
                    "adress",
                ...
                (
                    "website",
                    models.URLField(
                        blank=True, help_text="website-ul companiei", null=True
                    ),
                ),
                (
                    "facebook",
                ...
                (
                    "linkdin",
                    models.URLField(
                        blank=True, help_text="pagina de linkdin a companiei", null=True
                    ),
                ),
                (
